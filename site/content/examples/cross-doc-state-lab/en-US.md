...
status: published
order: 15
summary: "Demonstrates SlexKit's most unique capability — cross-fence state sharing where multiple slex code blocks in different positions of a document share the same reactive g object."
