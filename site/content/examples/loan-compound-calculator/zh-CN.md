  ...
  layout: {
    "card:compound": {
      ...
      "grid:params": {
        ...
        "column:cpField": { "slider:compoundingsPerYear": { label: "复利频次 n", "$value": "g.compoundingsPerYear", min: 1, max: 365, step: 1, unit: "次/年", onchange: "g.compoundingsPerYear = Number($event)" } }
      },
