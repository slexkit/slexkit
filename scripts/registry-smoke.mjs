...
writeFileSync(
  ...
  [
    ...
    "for (const id of ['@slexkit/theme-shadcn/style.css', '@slexkit/theme-shadcn/base.css', '@slexkit/theme-shadcn/components/button.css', '@slexkit/streamdown/style.css', '@slexkit/tiptap/style.css']) require.resolve(id);",
